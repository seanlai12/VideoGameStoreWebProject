 ...
 <select name = "category" onchange="dothis()">
  ...
  <br>
   ...
   <c:forEach var="user" items="${listUsers.rows}">
    ...
    <%-- <p id = "p1">
     <a id = "a1" href="<%=id1 %>/product.jsp?productCode=1"><%=s1 %></a><br>
     <a id = "a2" href="<%=id1 %>/product.jsp?productCode=2"><%=s2 %></a><br>
     <a id = "a3" href="<%=id1 %>/product.jsp?productCode=3"><%=s3 %></a><br>
     <a id = "a4" href="<%=id1 %>/product.jsp?productCode=4"><%=s4 %></a><br>
   </p> --%>
</td>
